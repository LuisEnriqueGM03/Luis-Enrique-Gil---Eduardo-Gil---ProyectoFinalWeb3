      ...
      >
        ...
        <div className="border-t border-secondary-200 p-4 flex-shrink-0">
          ...
          <div className="space-y-1">
            <button className="flex items-center w-full px-3 py-2 text-sm text-secondary-600 hover:bg-secondary-100 rounded-lg transition-colors duration-200">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:block">
                <span className="text-sm text-secondary-600">
                  Bienvenido, <span className="font-medium">{state.user?.username}</span>
                </span>
              </div>
            </div>
          </div>
