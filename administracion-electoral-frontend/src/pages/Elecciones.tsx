...
import { Eleccion, EleccionFormData, TipoEleccion } from '../models/eleccion';
...
const EleccionesPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingEleccion) {
        await eleccionesService.updateEleccion(editingEleccion.id, formData);
        toast.success('Elección actualizada exitosamente');
      } else {
        await eleccionesService.createEleccion(formData);
  ...
  const handleDelete = async (eleccion: Eleccion) => {
    ...
    try {
      await eleccionesService.deleteEleccion(eleccion.id);
