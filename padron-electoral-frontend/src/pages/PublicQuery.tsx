...
import { ConsultaPadron } from '../types';
...
const PublicQuery: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await apiService.consultarPadron(ci.trim());
      setResultado(data);
    } catch (err: any) {
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-blue-700">{resultado.recinto_nombre}</p>
                </div>
              </div>

              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-800">
                  <strong>Importante:</strong> Recuerda llevar tu cédula de identidad el día de las elecciones 
                  y dirigirte al recinto electoral indicado.
                </p>
              </div>
            </div>
          )}
